...
// limit-cycle buzz (see [[reach-policy-buffer-convention]]). Bounds are set to
 ...
 * drawn from the paper's predefined-EE evaluation sequences
 * (`run_scripts/reach/reach_predefined_ee_example*.json`). Now that the arm is
